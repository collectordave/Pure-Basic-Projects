...
DeclareModule Main
  ...
  Global spnSides.i,strRotation.i,optOpen.i,optClosed.i,btnEditPath.i,strFont.i
...
Global HelpWindow.i,ViewIconWindow.i
  ...
  EndProcedure
    ...
    If DatabaseQuery(AppMain::ShapesDB, Criteria)
      If FirstDatabaseRow(AppMain::ShapesDB) = 0
        ...
        If DatabaseQuery(AppMain::ShapesDB, "SELECT * FROM Icons WHERE Title = '" + NewIcon::Name + "';") 
  ...
  Procedure ShowEditGadgets(Type.s)
    ...
    Select Type ;GetGadgetText(strType)
      ...
      Case "Arc"
        ...
        strX1 = StringGadget(#PB_Any, 55, 25, 35, 20, "")
        strY1 = StringGadget(#PB_Any, 95, 25, 35, 20, "")
        TextGadget(#PB_Any, 15, 55, 35, 20, "Radius", #PB_Text_Right)
        strRadiusX = StringGadget(#PB_Any, 55, 50, 30, 20, "")
        TextGadget(#PB_Any, 10, 80, 40, 20, "Angle 1", #PB_Text_Right)   
        spnAngle1 = SpinGadget(#PB_Any, 55,75, 50, 20, 0, 360, #PB_Spin_Numeric)   
        TextGadget(#PB_Any, 10, 105, 40, 20, "Angle 2", #PB_Text_Right)      
        spnAngle2 = SpinGadget(#PB_Any, 55, 100, 50, 20, 0, 360, #PB_Spin_Numeric)  
        optOpen = OptionGadget(#PB_Any, 10, 130, 45, 20, "Open")
        optClosed = OptionGadget(#PB_Any, 55, 130, 70, 20, "Closed")
      ...
      Case "Box"
        ...
        strX1 = StringGadget(#PB_Any, 55, 20, 35, 20, "")
        strY1 = StringGadget(#PB_Any, 95, 20, 35, 20, "")
        TextGadget(#PB_Any, 10,55, 35, 20, "End", #PB_Text_Right)
        strX2 = StringGadget(#PB_Any, 55, 50, 35, 20, "")
        strY2 = StringGadget(#PB_Any, 95, 50, 35, 20, "")      
      ...
      Case "Curve"
         ...
         strX1 = StringGadget(#PB_Any, 55, 30, 35, 20, "")
         strY1 = StringGadget(#PB_Any, 95, 30, 35, 20, "")
         TextGadget(#PB_Any, 15, 60, 30, 20, "End", #PB_Text_Right)
         strX4 = StringGadget(#PB_Any, 55, 55, 35, 20, "")
         strY4 = StringGadget(#PB_Any, 95, 55, 35, 20, "")      
         TextGadget(#PB_Any, 15, 85, 30, 20, "Pull 1", #PB_Text_Right)
         strX2 = StringGadget(#PB_Any, 55, 80, 35, 20, "")
         strY2 = StringGadget(#PB_Any, 95, 80, 35, 20, "")    
         TextGadget(#PB_Any, 15, 110, 30, 20, "Pull 2", #PB_Text_Right)
         strX3 = StringGadget(#PB_Any, 55, 105, 35, 20, "")
         strY3 = StringGadget(#PB_Any, 95, 105, 35, 20, "")
       ...
       Case "Ellipse"
         ...
         strRadiusX = StringGadget(#PB_Any, 95, 55, 35, 20, "")
         TextGadget(#PB_Any, 15, 90, 45, 20, "Y Radius", #PB_Text_Right)     
         strRadiusY = StringGadget(#PB_Any, 95, 85, 35, 20, "")     
         TextGadget(#PB_Any, 15, 120, 45, 20, "Rotation", #PB_Text_Right)
         strRotation = StringGadget(#PB_Any, 95, 115, 30, 20, "") 
      ...
      Case "Path"
        ...
        optOpen = OptionGadget(#PB_Any, 10, 5, 45, 20, "Open")
        optClosed = OptionGadget(#PB_Any, 55, 5, 70, 20, "Closed")   
        btnEditPath = ButtonGadget(#PB_Any, 15, 30, 120, 25, "Edit Path")  
        
      Case "Poly"
  
        TextGadget(#PB_Any, 5, 10,50, 20, "Sides", #PB_Text_Right)   
        spnSides = SpinGadget(#PB_Any, 80, 10, 50, 20, 3, 10, #PB_Spin_Numeric)    
        ...
        strX1 = StringGadget(#PB_Any, 55, 55, 35, 20, "")
        strY1 = StringGadget(#PB_Any, 95, 55, 35, 20, "")       
        TextGadget(#PB_Any, 15, 85, 35, 20, "Radius", #PB_Text_Right)
        strRadiusX = StringGadget(#PB_Any, 55, 80, 30, 20, "")
        TextGadget(#PB_Any, 5, 110, 45, 20, "Rotation", #PB_Text_Right)
        strRotation = StringGadget(#PB_Any, 55, 105, 30, 20, "") 
       ...
       Case "Shape"
        ...
        strRotation = StringGadget(#PB_Any, 55, 75, 30, 20, "")        
      ...
      Case "Star"
        ...
        strX1 = StringGadget(#PB_Any, 55, 60, 35, 20, "")
        strY1 = StringGadget(#PB_Any, 95, 60, 35, 20, "")       
        TextGadget(#PB_Any, 5, 95, 75, 20, "Outer Radius", #PB_Text_Right)
        strRadiusX = StringGadget(#PB_Any, 95, 90, 35, 20, "")
        TextGadget(#PB_Any, 5, 125, 75, 20, "Inner Radius", #PB_Text_Right)
        strRadiusY = StringGadget(#PB_Any, 95, 120, 35, 20, "")    
        TextGadget(#PB_Any, 5, 155, 75, 20, "Rotation", #PB_Text_Right)
        strRotation = StringGadget(#PB_Any, 95, 150, 35, 20, "")       
        
      Case "Text"
        
        TextGadget(#PB_Any, 10, 10, 40, 20, "Text", #PB_Text_Right)
        strText = StringGadget(#PB_Any, 70, 10, 70, 20, "")
        btnFont = ButtonGadget(#PB_Any, 10, 40, 50, 20, "Font")
        TextGadget(#PB_Any, 75, 40, 30, 20, "Size", #PB_Text_Right)
        spnSize = SpinGadget(#PB_Any, 110, 40, 40, 20, 5, 50,#PB_Spin_Numeric)        
        strFont = StringGadget(#PB_Any, 10, 70, 140, 20, "")        
        TextGadget(#PB_Any, 65, 100, 20, 20, "X")
        TextGadget(#PB_Any, 105, 100, 20, 20, "Y")
        TextGadget(#PB_Any, 10, 125, 40, 20, "Centre")
        strX1 = StringGadget(#PB_Any, 60, 120, 30, 20, "")
        strY1 = StringGadget(#PB_Any, 100, 120, 30, 20, "")     
        TextGadget(#PB_Any, 10, 155, 45, 20, "Rotation", #PB_Text_Right)
        strRotation = StringGadget(#PB_Any, 60, 150, 30, 20, "") 
...
EndProcedure
  ...
  Procedure DrawShape(*Element.AppMain::DrawObject)
    ...
    Define DrawColour.i = RGBA(Red(*Element\Colour),Green(*Element\Colour),Blue(*Element\Colour),255)
    Define DrawTrans.i = Alpha(*Element\Colour)
    Define Scale.d = (*Element\RadiusX) /100
    ...
    If DatabaseQuery(AppMain::ShapesDB, "SELECT * FROM ShapeElements WHERE ShapeID = " + Str(*Element\RadiusY) + ";")
      ...
      While NextDatabaseRow(AppMain::ShapesDB)
        ...
        Select ShapeElement\Pathtype
          ...
          Case "Ellipse"
            Debug "Ellipse"
            AddPathEllipse(ShapeElement\X1, ShapeElement\Y1, ShapeElement\RadiusX, ShapeElement\RadiusY)            
            FinishPath(@ShapeElement.AppMain::DrawObject)
     ...
     ;   EndIf
        ...
        Select Elements(iLoop)\PathType
         ...
         ;Case "Path"
            ...
            ;DrawPath(Elements(iLoop)\StartX,Elements(iLoop)\StartY,Elements(iLoop)\OuterRadius,Elements(iLoop)\Trans,Elements(iLoop)\StartAngle)
...
Procedure Redraw()
  ...
  Select Elements(CurrentElement)\PathType
    ...
    Case "Text"
      ...
      ;Elements(CurrentElement)\Font = SelectedFont
      Elements(CurrentElement)\X1 = Val(GetGadgetText(strX1))
      Elements(CurrentElement)\Y1 = Val(GetGadgetText(strY1))
      ...
      Case #PB_Event_Menu
        ...
        Case #mnuIconLoad
          ...
          If LoadIcon::OkPressed = #True
            SelectedShape_id = LoadIcon::SelectedShapeID
            LoadElements()
            CurrentElement = 0
            ShowElement(@Elements(CurrentElement))
            WhereToDraw("Canvas")
